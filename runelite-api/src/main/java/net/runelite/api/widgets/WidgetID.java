...
public final class WidgetID {
    ...
    public static final int TOURNAMENT_OVERLAY_GROUP_ID = 1035;
    public static final int WILDERNESS_BOSS_DAMAGERS = 1041;
    public static final int DEADMAN_SPECTATOR = 154;

    static class DeadmanSpectator {
    ...
    static class WildernessBossDamagers {
        static final int CONTAINER = 1;

        WildernessBossDamagers() {
        }
    }

    static class TournamentOverlay {
        static final int CONTAINER = 1;
