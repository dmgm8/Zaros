...
enum DiscordGameEventType {
    ...
    private DiscordGameEventType(String state, int priority, boolean shouldClear, boolean shouldTimeout, boolean shouldRestart, boolean shouldBeCleared, boolean root) {
        this.state = state;
        this.priority = priority;
    ...
    private DiscordGameEventType(@Nullable String imageKey, String state, String details, int priority, boolean root, boolean shouldClear, boolean shouldTimeout, @Nullable boolean shouldRestart, @Nullable boolean shouldBeCleared, DiscordAreaType discordAreaType, int[] regionIds) {
