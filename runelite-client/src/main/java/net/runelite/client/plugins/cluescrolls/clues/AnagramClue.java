...
ObjectClueScroll {
    ...
    public static class AnagramClueBuilder {
        ...
        public String toString() {
            return "AnagramClue.AnagramClueBuilder(text=" + this.text + ", npc=" + this.npc + ", location=" + (Object)this.location + ", area=" + this.area + ", question=" + this.question + ", answer=" + this.answer + ", objectId$value=" + this.objectId$value + ")";
        }
    }
}
